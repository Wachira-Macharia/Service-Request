...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($pno_err) && empty($email_err) && empty($subject_err) && empty($details_err)) {
        ...
        $sql = "INSERT INTO design (ticket_no, personal_number, email, subject, details) VALUES (?, ?, ?, ?, ?)";
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Design Request</h2>
                    <p>Please fill this form and submit to create a request for your design service.</p>
